...
class TraceQMCMC(TraceQPermutation):  # Probably don't want to really inherit from TraceQPermutation, but it works for now
    def __init__(self, K, data, inputs, platedims, reparam, device, indexed_samples):
        super().__init__(K, data, inputs, platedims, reparam, device)
