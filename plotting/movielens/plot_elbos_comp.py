...
with plt.rc_context(bundles.icml2022()):
    ...
    plt.savefig('charts/chart_movielens_comp_predll.png'.format(N, M))
    plt.savefig('charts/chart_movielens_comp_predll.pdf'.format(N, M))
...
with plt.rc_context(bundles.icml2022()):
    ...
    # fig.tight_layout()
    plt.legend()
    plt.savefig('charts/chart_movielens_comp_elbo.png'.format(N, M))
    plt.savefig('charts/chart_movielens_comp_elbo.pdf'.format(N, M))
