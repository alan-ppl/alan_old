...
class tests(unittest.TestCase):
    def test_plated_gaussian(self):
        ...
        def P(tr):
            ...
            '''
            a = t.zeros(5,)
            tr['mu'] = alan.MultivariateNormal(a, t.eye(5))
            tr['obs'] = alan.Normal(tr['mu'], t.tensor(1), sample_dim=plate_1)
        ...
        class Q(nn.Module):
            ...
            def forward(self, tr):
                tr['mu'] = alan.MultivariateNormal(self.m_mu, t.diag(self.log_s_mu.exp()))
    ...
    def test_gaussian(self):
        ...
        def P(tr):
          ...
          tr['mu'] = alan.MultivariateNormal(a, sigma_0)
          tr['obs'] = alan.MultivariateNormal(tr['mu'], sigma, sample_dim=plate_1)
        ...
        class Q(nn.Module):
            ...
            def forward(self, tr):
                ...
                tr['mu'] = alan.MultivariateNormal(self.m_mu, covariance_matrix=sigma_nn)
        ...
        y_hat = alan.dename(data['obs']).mean(axis=0).reshape(-1,1)
    ...
    def test_linear_gaussian(self):
        ...
        def P(tr):
          ...
          tr['w'] = alan.MultivariateNormal(a, sigma_w*t.eye(2))
          tr['obs'] = alan.Normal(tr['w'] @ data_x, sigma_y)
        ...
        class Q(nn.Module):
            ...
            def forward(self, tr):
                ...
                tr['w'] = alan.MultivariateNormal(self.m_mu, sigma_nn)
