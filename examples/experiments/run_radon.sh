...
lbatch -c 1 -g 1 -m 22 -t 35 -q cnu --cmd python runner.py dataset=radon model=radon_unif_alongreadings training.inference_method=elbo_tmc_new training.num_iters=50000
