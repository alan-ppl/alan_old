### LIW
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py local=True dataset=movielens model=movielens training.inference_method=elbo training.N=5 training.M=150
...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py local=True dataset=movielens model=movielens training.inference_method=elbo training.N=10 training.M=150
...
### TPP
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens training.inference_method=elbo training.N=5 training.M=150
...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens training.inference_method=elbo training.N=10 training.M=150
