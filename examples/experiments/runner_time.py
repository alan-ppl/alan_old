...
def run_experiment(cfg):
    ...
    for K in Ks:
        ...
        results_dict[N][M][K] = {'avg_time':np.mean(times), 'std_time':np.std(times)}

    file = cfg.dataset + '/results/' + cfg.model + '/' + cfg.training.inference_method + '_time_' + 'N{0}_M{1}.json'.format(N,M)
