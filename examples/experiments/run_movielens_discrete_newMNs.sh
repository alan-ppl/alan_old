### RWS discrete
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens_discrete training.inference_method=rws training.N=5 training.M=10 training.pred_ll.do_pred_ll=True
...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens_discrete training.inference_method=rws training.N=10 training.M=10 training.pred_ll.do_pred_ll=True
...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens_discrete training.inference_method=rws_global training.N=5 training.M=10 training.pred_ll.do_pred_ll=True
...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu --cmd python runner.py dataset=movielens model=movielens_discrete training.inference_method=rws_global training.N=10 training.M=10 training.pred_ll.do_pred_ll=True
