...
t.save(t.from_numpy(run_type)[:2,:,:,:], 'data/run_type_train.pt')
t.save(t.from_numpy(bus_company_name)[:2,:,:,:], 'data/bus_company_name_train.pt')
t.save(t.from_numpy(delay)[:2,:,:], 'data/delay_train.pt')

t.save(t.from_numpy(run_type)[2:,:,:,:], 'data/run_type_test.pt')
t.save(t.from_numpy(bus_company_name)[2:,:,:,:], 'data/bus_company_name_test.pt')
t.save(t.from_numpy(delay)[2:,:,:], 'data/delay_test.pt')
