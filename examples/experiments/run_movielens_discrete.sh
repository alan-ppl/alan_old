...
lbatch -c 1 -g 1 -m 22 -t 10 -q cnu -a cosc020762 --gputype A100 --cmd python runner.py dataset=movielens model=movielens_discrete training.inference_method=rws_global training.N=5 training.M=300 training.pred_ll.do_pred_ll=True training.Ks=[1,3,10,30,100,300]
