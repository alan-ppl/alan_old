...
plate_state, plate_county, plate_zipcode, plate_reading = dims(4 , [2,2,2,4])
...
class Q(tpp.Q_module):
    def __init__(self):
        ...
        #alpha
        self.reg_param("alpha_mu", t.zeros((2,2)), [plate_state, plate_county])
        self.reg_param("log_alpha_sigma", t.zeros((2,2)), [plate_state, plate_county])
        ...
        #omega
        self.reg_param("omega_mu", t.zeros((2,2,2)), [plate_state, plate_county, plate_zipcode])
        self.reg_param("log_omega_sigma", t.zeros((2,2,2)), [plate_state, plate_county, plate_zipcode])
