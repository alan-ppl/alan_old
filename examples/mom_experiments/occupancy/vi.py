...
parser.add_argument('--num_runs',      '-n',   type=int,   nargs='?', default=10,                  help="number of runs")
...
parser.add_argument('--vi_lrs',        '-l',   type=float, nargs='+', default=[0.1, 0.01, 0.001, 0.0001], help="learning rates for VI")
